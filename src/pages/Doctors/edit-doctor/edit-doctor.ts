...
/**
 * Generated class for the EditDoctorPage page.
 *
...
export class EditDoctorPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad EditDoctorPage');
  }
  ...
  edit_doctor() {
    ...
    if (this.item_edit.image == this.path_image) {
      ...
      this.http.post("https://kalansarigroup.com/vendor/all_doctors.php/update", this.items).subscribe(data => {
        console.log(data);
      ...
      this.http.post("https://kalansarigroup.com/vendor/all_doctors.php/update_img", this.items).subscribe(data => {
        console.log(data);
        let result = JSON.parse(data["_body"]);
        console.log(result);
